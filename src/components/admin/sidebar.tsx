  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed top-0 left-0 z-50 h-14 w-14 flex items-center justify-center lg:hidden text-zinc-400 hover:text-zinc-200 transition-colors"
      ...
      {/* Sidebar panel */}
      <aside
        className={`fixed left-0 top-0 z-40 h-screen w-64 flex flex-col border-r border-amber-900/30 bg-[#0c0a07] transition-transform duration-300 ease-in-out ${
      ...
      >
        ...
        <div className="relative flex items-center gap-3 px-5 py-5 border-b border-amber-900/30">
          ...
          <button
            onClick={closeMobile}
            className="lg:hidden p-1.5 rounded-lg text-zinc-500 hover:text-zinc-200 hover:bg-white/5 transition-colors"
